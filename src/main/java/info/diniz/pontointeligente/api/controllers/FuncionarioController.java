...
import info.diniz.pontointeligente.api.dtos.FuncionarioDto;
...
public class FuncionarioController {
	...
	private FuncionarioDto converterFuncionarioDto(Funcionario funcionario) {
		...
		funcionario.getQtdHorasTrabalhoDiaOpt()
			.ifPresent(qtdHorasTrabalhoDia -> dto.setQtdHorasTrabalhoDia(Optional.of(Float.toString(qtdHorasTrabalhoDia))));
